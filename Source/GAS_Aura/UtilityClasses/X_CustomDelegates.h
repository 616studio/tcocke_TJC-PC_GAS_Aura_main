...
#include "X_CustomDataTypes.h"
#include "GameplayTagContainer.h"
#include "X_CustomDelegates.generated.h"
 ...
 * <list type="bullet">
 * <item><description><b>Dynamic Delegates Require Reflection:</b> DECLARE_DYNAMIC_MULTICAST_DELEGATE_* macros allow delegates to be serialized and bound inside Blueprint Event Graphs (BlueprintAssignable). Due to this Blueprint serialization, UHT must generate C++ reflection glue code for them inside X_UI_Delegates.generated.h.</description></item>
 * <item><description><b>The UHT Parser Conflict:</b> Native C++ delegates (DECLARE_MULTICAST_DELEGATE_*) are non-reflected and do not use .generated.h. However, since the header contains DECLARE_DYNAMIC_MULTICAST_DELEGATE_* macros, we are forced to include #include "X_UI_Delegates.generated.h".</description></item>
...
// 
USTRUCT()
struct FX_CustomDelegates_DummyStruct
{
	GENERATED_BODY()
};
